...
import mine.spring.mvc.domain.dto.SimpleValidationDto;
...
@RestController
@RequestMapping("/simpleBeanValidation")
public class SimpleBeanValidationController {

    @Autowired
    private MessageUtil messageUtil;

    @RequestMapping(method = RequestMethod.GET)
    public AbstractResponse validate(@Valid @ModelAttribute SimpleValidationDto simpleValidationDto,
