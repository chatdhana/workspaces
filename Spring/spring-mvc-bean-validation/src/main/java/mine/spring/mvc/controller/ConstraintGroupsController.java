...
import mine.spring.mvc.domain.dto.ConstraintGroupingDto;
...
@RestController
@RequestMapping("/contraintGroups")
public class ConstraintGroupsController {

    @Autowired
    private MessageUtil messageUtil;

    @RequestMapping(method = RequestMethod.GET)
    public AbstractResponse validate(@Valid @ModelAttribute ConstraintGroupingDto constraintGroupingDto,
