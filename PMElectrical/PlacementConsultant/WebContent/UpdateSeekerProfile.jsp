...
<title>Update Seeker Profile</title>
...
<div id="center">
<s:form action="updateseekerprofile" name="seekerprofileform" method="post" enctype="multipart/form-data">
<%
...
<a href="viewresume.action">View Previous Resume</a>
</div>
<p>&nbsp;</p>
<p>&nbsp;</p>
