...
<div id="right">
   ...
   <h2 class="title"><a href="toupdaterecruiter.action" title="Update your profile">Update Profile</a> </h2>
   <div class="content2">
  ...
  <div id="login" class="boxed">
   <h2 class="title"><a href ="postJobHome.action">Post Jobs</a></h2>
   <div class="content2">
...
<div id="login" class="boxed">
   <h2 class="title" ><a href="RecruiterReport">Report </a></h2>
   <div class="content2">
