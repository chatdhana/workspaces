...
<s:form name="form1" id="form1" action="searchJob" >

<s:select name="desigT" label="Designation " list="desig" headerKey="-1" headerValue=" Select Designation"  ></s:select>
<s:select name="skillT" list="skill"   label="Skill " headerKey="-1" headerValue="Select Skill" ></s:select>
<s:select name="experienceT"list="experience"  label="Experience " headerKey="-1" headerValue="Select Experience" ></s:select>
<s:select name="locationT" list="location"  label="Location" headerKey="-1" headerValue="Select Location"  ></s:select>
<s:select name="funAreaT" list="funArea"  label="Functional Area" headerKey="-1" headerValue="Select Functional Area" ></s:select>
<s:select  name="minSalT" list="minSal"  label="Min Salary" headerKey="-1" headerValue="Select Min Salary" onchange="dojo.event.topic.publish('maxSalTopic');return false;" ></s:select>
<s:url id="SalaryUrl" action="maxSalAjax" />




<s:form>
<s:div  href="%{SalaryUrl}"  listenTopics="maxSalTopic" formId="form1" theme="ajax"  loadingText=" Loading Salary..."></s:div>
<br><br><br>
<s:submit  value="Search Job"></s:submit> 
</s:form>
