...
String jcount=(String)request.getAttribute("jcount");
out.println("Company Name : "+cname);
out.print("<br/>");
out.print("<br/>");
out.println("No Of Jobs Posted"+" :"+jcount);
out.print("<br/>");
out.print("<br/>");
...
while(rs.next())
{
	out.println("Designation   :  "+rs.getString(1));out.print("<br/>");
	out.println("Skill         : "+rs.getString(2));out.print("<br/>");
	out.println("Functional Area:  "+rs.getString(3));out.print("<br/>");
	out.println("Posted Date :  "+rs.getString(4));out.print("<br/>");
	out.print("<br/>");
	out.print("<br/>");
}
