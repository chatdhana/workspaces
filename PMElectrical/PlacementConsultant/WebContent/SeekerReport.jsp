...
<%
int count=0;
String c=(String)request.getAttribute("a");
out.println("Number of jobs applied:"+c);
out.println("<br/>");
out.println("<br/>");
ResultSet rs=(ResultSet)request.getAttribute("rt");

while(rs.next())
{
	out.println("Company Name    : "+rs.getString(1));out.print("<br/>");
	out.println("Designation     : "+rs.getString(2));out.print("<br/>");
	out.println("Skill           : "+rs.getString(3));out.print("<br/>");
	out.println("Functional Area : "+rs.getString(4));out.print("<br/>");
	out.print("<br/>");
	out.print("<br/>");
	out.print("<br/>");
}
