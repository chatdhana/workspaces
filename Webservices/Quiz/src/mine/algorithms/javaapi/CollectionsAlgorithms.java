...
public class CollectionsAlgorithms {
	...
	void shuffling() {
		...
		List<Mobile> sorted1= new ArrayList<Mobile>();
		List<Mobile> sorted2= new ArrayList<Mobile>();
	...
	void dataManipulation() {
		...
		// addAll
		List<Mobile> clonedList = new ArrayList<Mobile>();
	...
	void composition() {
		...
		System.out.println("Composition: disjoint():"+Collections.disjoint(unsortedlist, new ArrayList<Mobile>()));
	}
	...
	List<Mobile> retMobilesList(int size) {
		List<Mobile> listOfMobiles = new ArrayList<Mobile>(size);
